...
public class Gun : MonoBehaviour
{
    ...
    private void AimDownSights()
    {
        if (Input.GetButton("Fire2") && !reloading)
        {
            ...
            transform.localPosition = Vector3.Lerp(transform.localPosition, aimPos, aimLerpSpeed * Time.deltaTime);
        ...
        else
        {
            ...
            transform.localPosition = Vector3.Lerp(transform.localPosition, originalPos, aimLerpSpeed * Time.deltaTime);
    ...
    private void Shoot()
    {
        ...
        {
            rayHit.point = fpsCam.transform.forward * range;
        }
